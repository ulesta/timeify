...
<body>
    ...
    <div class="menu">
        ...
        <div class="menuToggle">
            <a href="#" class="toggle_btn" id="toggleMenu"><img id="toggleBtn" src="./assets/btn_togglemenu.png" width="65px" height="40px" /></a>
        </div>
        <div class="menuBar">
            <input type="file" accept="image/*" capture="camera" id="file-input" style="visibility:hidden;" />
            <a href="#" class="menu_btn"><img id="cameraBtn" src="./assets/btn_camera.png" width="75px" height="75px" /></a>
            <!-- Picture Btn End -->
